      ...
      <section>
        <div className='px-8 py-12'>
          <div className='flex flex-col md:flex-row'>
            ...
            <div className='w-full md:w-[40%] h-auto md:h-[580px] bg-green-500 flex justify-center items-end'>
              <Image src={require('../../public/fresh/right.png')} width={400} height={400} alt='right' />
            </div>
          </div>
        </div>
      </section>
